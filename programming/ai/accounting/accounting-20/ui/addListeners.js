...
document.getElementById('show-tax-year-2021-2022').addEventListener('click', () => {
    filterByTaxYear(2021);
    updateActiveButton('show-tax-year-2021-2022');
    updateHeadings('Tax Year', 2021);
});

document.getElementById('show-tax-year-2022-2023').addEventListener('click', () => {
    filterByTaxYear(2022);
    updateActiveButton('show-tax-year-2022-2023');
    updateHeadings('Tax Year', 2022);
});

document.getElementById('show-tax-year-2023-2024').addEventListener('click', () => {
    filterByTaxYear(2023);
    updateActiveButton('show-tax-year-2023-2024');
    updateHeadings('Tax Year', 2023);
});
