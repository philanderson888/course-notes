...
function filterData() {
    ...
    displayCleansedTransactions(filterByDateAndCategory);
    displayCleansedCharityTransactions(filterByDateAndCategory);
    const sortedExpenditureCategories = displaySummaryData(filterByDateAndCategory);
...
function filterByYear(year) {
    ...
    displayCleansedTransactions(filteredData);
    displayCleansedCharityTransactions(filteredData);
    const sortedExpenditureCategories = displaySummaryData(filteredData);
    updateBarChart(sortedExpenditureCategories);
    updatePieChart(sortedExpenditureCategories);    
}
...
function filterByTaxYear(year) {
    ...
    console.log(' ');
    console.log(`filter by tax year ... ${year} - ${year + 1}`);
