...
document.getElementById('show-2022').addEventListener('click', () => filterByYear(2022));
document.getElementById('show-2023').addEventListener('click', () => filterByYear(2023));
document.getElementById('show-2024').addEventListener('click', () => filterByYear(2024));
