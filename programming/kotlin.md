...
- [code](#code)
  ...
  - [Terms](#terms)
    - [flux](#flux)
    - [Mono is a stream which can emit one item](#mono-is-a-stream-which-can-emit-one-item)
    - [Kotlin Flows = Rx = Reactive Extensions = Reactive Streams have callback onNext, onCompleted and onError#](#kotlin-flows--rx--reactive-extensions--reactive-streams-have-callback-onnext-oncompleted-and-onerror)
  - [Reference](#reference)
    - [Keywords](#keywords)
  - [glossary](#glossary)
